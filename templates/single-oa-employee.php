 ...
 *
 * This template can be overridden by copying it to yourtheme/openasset/single-employee.php.
 *
 * @package OpenAsset
 */
...
while ( have_posts() ) :
	...
	$helpers->get_template_part( 'template-parts/content/content', 'oa-employee' );
